...
new_list = [] #create an empty list that will take the final data
...
for page in range(1, 50):
    ...
    soup = bs(page.content, 'lxml')
      #create a function that will access the inner pages of each car to get the transmission detail
    def get_other_car_detail(href):
      ...
      # get the name, price, mileage and colour of each car
    ...
    colour = soup.select('div.sv-left-pane > div.sv-desc-container.middle > span:nth-child(5)')
      ...
      #combine all the data to the list with the different headers
